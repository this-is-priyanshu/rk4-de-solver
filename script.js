    ...
    document.getElementById('form').addEventListener('submit', function(event) {
                ...
                if (i === 0) 
                    {
                        ...
                        row.innerHTML = `<td>0</td><td>${x0.toFixed(5)}</td><td>--</td><td>--</td><td>--</td><td>--</td><td>${x_val[i+1] ? x_val[i+1].toFixed(5) : '--'}</td><td>${y0.toFixed(5)}</td>`;
                        tableBody1.appendChild(row);
                    } 
                    else 
                    {
                        row = document.createElement('tr');
                        row.innerHTML = `<td>${i}</td><td>${x_val[i].toFixed(5)}</td><td>${k1_val[i].toFixed(5)}</td><td>${k2_val[i].toFixed(5)}</td><td>${k3_val[i].toFixed(5)}</td><td>${k4_val[i].toFixed(5)}</td><td>${x_val[i+1] ? x_val[i+1].toFixed(5) : '--'}</td><td>${y_val[i].toFixed(5)}</td>`;
                        tableBody1.appendChild(row);
                    }
            }
        ...
        else if(derivative == 'second')
        {
            ...
            for (let i = 0; i < x_val.length; i++) 
            {
                ...
                {
                    row = document.createElement('tr');
                    row.innerHTML = `<td>0</td><td>${x0.toFixed(5)}</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>--</td><td>${x_val[i+1] ? x_val[i+1].toFixed(5) : '--'}</td><td>${y0.toFixed(5)}</td><td>${z0.toFixed(5)}</td>`;
                    tableBody2.appendChild(row);
                } 
                else 
                {
                    row = document.createElement('tr');
                    row.innerHTML = `<td>${i}</td><td>${x_val[i].toFixed(5)}</td><td>${k1_val[i].toFixed(5)}</td><td>${l1_val[i].toFixed(5)}</td><td>${k2_val[i].toFixed(5)}</td><td>${l2_val[i].toFixed(5)}</td><td>${k3_val[i].toFixed(5)}</td><td>${l3_val[i].toFixed(5)}</td><td>${k4_val[i].toFixed(5)}</td><td>${l4_val[i].toFixed(5)}</td><td>${x_val[i+1] ? x_val[i+1].toFixed(5) : '--'}</td><td>${y_val[i].toFixed(5)}</td><td>${z_val[i].toFixed(5)}</td>`;
                    tableBody2.appendChild(row);
                }
            }
